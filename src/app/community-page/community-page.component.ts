...
host:any = environment.host
  ...
  communities:any = []
  vendor_id:any = null
  @Input() set vendorId(vendorId:any){
    this.vendor_id = vendorId
    if(this.vendor_id && this.loggedUserInfo){
      
      this.getCommunity(this.vendor_id)
    }
  }
